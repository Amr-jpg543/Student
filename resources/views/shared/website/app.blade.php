...
<head>
    ...
    <!-- mean menu css -->
    <link rel="stylesheet" href="/website/assets/css/meanmenu.min.css">
    <!-- main style -->
...
<body>
                                ...
                                <li>
                                    <div class="header-icons">
                                        @auth
                                            ...
                                            <a href="{{ route('logout') }}" class="user-account for-buy"><i
                                        ...
                                        @guest
                                            ...
                                            <a href="{{ route('register') }}" class="user-account for-buy"><i
                                                    class="icon icon-user"></i><span>Sign Up</span></a>
                                        @endguest
                                    </div>
                                </li>
                    ...
                    <div class="testimonial-sliders">
                        <div class="single-testimonial-slider">
                            <div class="client-avater">
                                <img src="/website/assets/img/avaters/avatar1.png" alt="">
                            </div>
                        ...
                        <div class="single-testimonial-slider">
                            <div class="client-avater">
                                <img src="/website/assets/img/avaters/avatar2.png" alt="">
                            </div>
                            <div class="client-meta">
                        ...
                        <div class="single-testimonial-slider">
                            <div class="client-avater">
                                <img src="/website/assets/img/avaters/avatar3.png" alt="">
                            </div>
                            <div class="client-meta">
                ...
                <div class="col-lg-12">
                    <div class="logo-carousel-inner">
                        <div class="single-logo-item">
                            <img src="/website/assets/img/company-logos/1.png" alt="">
                        </div>
                        <div class="single-logo-item">
                            <img src="/website/assets/img/company-logos/2.png" alt="">
                        </div>
                        <div class="single-logo-item">
                            <img src="/website/assets/img/company-logos/3.png" alt="">
                        </div>
                        <div class="single-logo-item">
                            <img src="/website/assets/img/company-logos/4.png" alt="">
                        </div>
                        <div class="single-logo-item">
                            <img src="/website/assets/img/company-logos/5.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- jquery -->
    <script src="/website/assets/js/jquery-1.11.3.min.js"></script>
    <!-- bootstrap -->
    <script src="/website/assets/bootstrap/js/bootstrap.min.js"></script>
    <!-- count down -->
    <script src="/website/assets/js/jquery.countdown.js"></script>
    <!-- isotope -->
    <script src="/website/assets/js/jquery.isotope-3.0.6.min.js"></script>
    <!-- waypoints -->
    <script src="/website/assets/js/waypoints.js"></script>
    <!-- owl carousel -->
    <script src="/website/assets/js/owl.carousel.min.js"></script>
    <!-- magnific popup -->
    <script src="/website/assets/js/jquery.magnific-popup.min.js"></script>
    <!-- mean menu -->
    <script src="/website/assets/js/jquery.meanmenu.min.js"></script>
    <!-- sticker js -->
    <script src="/website/assets/js/sticker.js"></script>
    <!-- main js -->
